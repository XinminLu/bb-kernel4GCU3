cmd_arch/arm/boot/dts/am335x-boneblack-bbb-exp-c.dtb := mkdir -p arch/arm/boot/dts/ ; /home/xinmin/gcc-linaro-arm-linux-gnueabihf-4.9-2014.09_linux/bin/arm-linux-gnueabihf-gcc -E -Wp,-MD,arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.d.pre.tmp -nostdinc -I./arch/arm/boot/dts -I./arch/arm/boot/dts/include -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.dts.tmp arch/arm/boot/dts/am335x-boneblack-bbb-exp-c.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/am335x-boneblack-bbb-exp-c.dtb -b 0 -i arch/arm/boot/dts/ -@ -d arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.d.dtc.tmp arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.dts.tmp ; cat arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.d.pre.tmp arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.d.dtc.tmp > arch/arm/boot/dts/.am335x-boneblack-bbb-exp-c.dtb.d
